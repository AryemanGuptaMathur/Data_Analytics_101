...
1.  Download RStudio: After installing R, go to the RStudio download page ([**https://www.rstudio.com/products/rstudio/download/**](https://www.rstudio.com/products/rstudio/download/)) and choose the version of RStudio that matches your operating system.
