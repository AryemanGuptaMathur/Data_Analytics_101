...
4.  
    ...
    -   Let's take a closer look at some of the most effective ways of Visualizing Univariate Continuous Data using the `ggplot2` and related packages, including
...
(iv) Bee Swarm plots;
(v) Violin plots;
(vi) Q-Q plots. Note that it is inconvenient to create Stem-and-Leaf plots using ggplot2 and hence we ignore this.
