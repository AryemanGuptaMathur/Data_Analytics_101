...
## Exploring bivariate Continuous x Categorical data

THIS CHAPTER explores how to summarize and visualize *bivariate continuous data across categories*.
...
color_vector <- c("lightpink", "lightblue")
