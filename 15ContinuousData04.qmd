...
### Probability Density Function (PDF) plot across one Category using `ggplot2`
...
### Cumulative Density Function (PDF) plot across one Category using `ggplot2`
...
# Create a CDF plot
ggplot(tb, 
       aes(x = mpg, y = cdf, color = factor(am))) +
  geom_line() +
