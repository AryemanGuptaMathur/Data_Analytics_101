...
## 4. Frequency Table for More than One Variable
...
## 5. `prop.table` Proportions Table for One Variable
...
## 6. `prop.table` Proportions Table for More than One Variable
...
## 7. `round()`: This function is used to set the width of decimal numbers
...
## 8. `addmargins()`: The row and column sums of a matrix or table are calculated using the addmargins() function in R, and the sums are then added as new rows and columns to the original matrix or table.
