...
### Chapter 02: The World of R Packages
...
### Chapter 03: Data Structures in R
...
Chapter 04 advances your understanding of data frames in R, highlighting techniques to read different file formats into a data frame, manage the working directory, merge data frames, and introduces tibbles. It explains the workings of a 'working directory' and showcases how to navigate and alter it for efficient file handling. The chapter illustrates how to read various file formats, such as CSV and Excel, into a data frame and merge multiple data sources. Lastly, it presents tibbles, a modern take on data frames, discussing their creation, conversion, and distinct features.
...
### Chapter 07: Diving Deep into tibbles & dplyr
