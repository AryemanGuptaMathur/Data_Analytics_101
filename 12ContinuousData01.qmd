...
2. Here is sample code to generate a boxplot of `mpg` (miles per gallon) values of the cars . 
```{r}
boxplot(tb$mpg, 
        xlab = "Boxplot",
        ylab = "Weight",
...
* The resulting plot unveils the entire `mpg` data distribution, with a kernel density estimate indicating the concentration of data points at different sections.
